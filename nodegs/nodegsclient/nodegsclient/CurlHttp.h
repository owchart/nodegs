...
*               Version 1.00 бя                                               *
*                                                                             *
*               Copyright (c) 2010-2014, Lord's OwChart. All rights reserved. *
...
namespace OwLib
{
	...
	public:
		string DownloadFile(string strFileUrl, string strFilePath, FileTransferListener *proParam = 0, int timeout = 600);
		...
		string UploadBitFile(string strUploadUrl, string strUploadFileName, FileTransferListener *progress /*= 0*/);
	};
}
#endif