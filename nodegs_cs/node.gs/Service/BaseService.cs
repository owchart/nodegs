...
namespace OwLibSV
{
    ...
    public class BaseService : IDisposable
    {
        ...
        /// 压缩类型
        /// </summary>
        protected Dictionary<int, int> m_compressTypes = new Dictionary<int, int>();
        ...
        /// 需要等待的请求ID
        /// </summary>
        private Dictionary<int, int> m_needWaitRequestIDs = new Dictionary<int, int>();
        ...
        /// <param name="socketID">连接ID</param>
        /// <returns>状态</returns>
        [DllImport("owsock_server.dll", EntryPoint = "CloseServer", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public extern static int CloseServer(int socketID);

        /// <summary>
        /// 注册回调
        /// </summary>
        /// <param name="callBack">回调函数</param>
        [DllImport("owsock_server.dll", EntryPoint = "RegisterServerCallBack", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        /// </summary>
        /// <param name="callBack">回调函数</param>
        [DllImport("owsock_server.dll", EntryPoint = "RegisterServerLog", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        /// <param name="len">长度</param>
        /// <returns>状态</returns>
        [DllImport("owsock_server.dll", EntryPoint = "SendByServer", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public extern static int SendByServer(int socketID, IntPtr str, int len);
        ...
        /// <returns>状态</returns>
        [DllImport("owsock_server.dll", EntryPoint = "StartServer", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public extern static int StartServer(int type, int port);
        ...
        public virtual int KeepAlive(int socketID)
        {
            ...
            int ret = SendByServer(socketID, ptr, length);
        ...
        public virtual int Send(CMessage message)
        {
            ...
            int ret = SendByServer(message.m_socketID, ptr, length);
            m_upFlow += ret;
            Marshal.FreeHGlobal(ptr);
            bw.Close();
            return ret;
